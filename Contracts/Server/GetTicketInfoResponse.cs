...
{
    /// <summary>
    /// Wrapper class for information about ticket
    /// </summary>
    public class GetTicketInfoResponse
    {
        public GetTicketInfoResponse(string id, string barcode, TicketStatus status, Visitor visitor, Buyer buyer, Session session,
            Payment payment, int visitDate, int refundDate, string refundRrn, string refundTicketPrice, string comment)
        { 
            Id = id;
            Barcode = barcode;
            Status = status;
